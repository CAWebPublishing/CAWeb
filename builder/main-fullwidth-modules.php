...
class ET_Builder_Module_Fullwidth_CA_Section_Carousel extends ET_Builder_Module {
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
     ...
     if("on" == $in_panel){
      ...
      $output  = sprintf('<div%1$s class="et_pb_ca_fullwidth_panel%2$s%3$s panel panel-%4$s">%5$s
       ...
       $output = sprintf('<div%1$s class="et_pb_ca_fullwidth_section_carousel%2$s%3$s section"%4$s>
				<div class="">
				<div class="group">
				<div class="col-md-12 ">
