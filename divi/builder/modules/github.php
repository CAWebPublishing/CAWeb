	...
	function get_fields() {
		...
		$design_fields = array(
			'email_body' => array(
				...
				'description'     => et_get_safe_localization( sprintf( __( 'Here you can create the content that will be used within the body. Content must use proper URL Encoding (e.g. %%0A = line feed, %%91 = [, %%93 = ] )<a href="%1$s" target="_blank" title="URL Encoding Reference">URL Encoding Reference</a>', 'et_builder' ), esc_url( 'https://www.w3schools.com/tags/ref_urlencode.asp' ) ) ),
