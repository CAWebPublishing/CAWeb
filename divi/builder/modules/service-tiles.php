    ...
    function render($unprocessed_props, $content = null, $render_slug) {
        ...
        for ($i = 0; $i < $tile_count; $i++) {
            ...
            if ("on" == $tiles[$i]['tile_link']) {
                ...
                $output .= sprintf('<div tabindex="%1$s" class="service-tile service-tile-empty %2$s" data-url="%3$s" data-link-target="new" >%4$s<div class="teaser"><h4 class="title">%5$s</h4></div></div>', $i + 1, $tile_size, $tiles[$i]['tile_url'], $item_image, $title);
            } else {
