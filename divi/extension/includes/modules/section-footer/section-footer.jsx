...
class CAWeb_Module_Section_Footer extends CAWEeb_Component {
  ...
  render() {
		...
		var classList = "et_pb_ca_section_footer et_pb_module " + classes;
...
export default CAWeb_Module_Section_Footer;
