...
class CAWeb_Module_Fullwidth_Section_Carousel_Slide extends CAWEeb_Component {

  static slug = 'et_pb_ca_fullwidth_section_carousel_slide';
  ...
  renderMediaSlide(){
    ...
    if( "on" === this.props.slide_show_more_button && "" !== slide_url ){
      button = <div className={"details text-center" + "" === this.props.slide_desc ? " mt-3" : ""}><a href={slide_url} target="_blank">{this.props.slide_title}</a></div>;
    }
  ...
  render() {
		var classList = "et_pb_ca_fullwidth_section_carousel_slide et_pb_module item ";
    var carousel_style = this.props.et_pb_ca_section_carousel_style;
...
export default CAWeb_Module_Fullwidth_Section_Carousel_Slide;
