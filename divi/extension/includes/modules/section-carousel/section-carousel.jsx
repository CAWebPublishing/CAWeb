...
class CAWeb_Module_Section_Carousel extends CAWEeb_Component {

  static slug = 'et_pb_ca_section_carousel';
  ...
  render() {
		...
		var classList = "et_pb_ca_section_carousel et_pb_module " + classes;
...
export default CAWeb_Module_Section_Carousel;
