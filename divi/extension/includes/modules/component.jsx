...
class CAWeb_Component extends Component {
	...
	caweb_get_google_map_place_link(addr, embed, classList = ''){
		...
		if( embed ){
			return (
			<Fragment>
				<iframe title="Map" src={'https://www.google.com/maps/embed/v1/place?q=' + addr + '&zoom=10&key=' + this.CAWebGoogleMapsEmbedAPIKey}></iframe>
			</Fragment>);
		}else{
			return (
				<Fragment>
