...
class CAWeb_Module_Post_Handler extends CAWEeb_Component {
	...
	renderEventDetail( postID ){
		...
		//caweb_get_the_post_thumbnail(null, 'thumbnail', array('class'=>'img-left pr-3'))
		return(
			<Fragment>
				{}
				<div class="description">
	...
	renderExamDetail( postID ){
		...
		//caweb_get_the_post_thumbnail(null, 'medium', array('class' => 'd-block mb-3'))
		return(
			<Fragment>
				<div class="header">
					{}
	...
	renderNewsDetail( postID ){
		...
		//caweb_get_the_post_thumbnail(null, array(150, 100), array('class' => 'img-left'))
