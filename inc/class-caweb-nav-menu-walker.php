			...
			<li id="menu-item-<?php print $item_id; ?>" class="<?php print implode( ' ', $classes ); ?>">
					<div class="menu-item-bar">
							<div class="menu-item-handle">
									<span class="item-title"><span class="menu-item-title"><?php print esc_html( $title ); ?></span> <span class="is-submenu" <?php print $submenu_text; ?>><?php _e( 'sub item' ); ?></span></span>
					...
					<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php print $item_id; ?>">
							...
							<p class="field-description description description-wide">
									<label for="edit-menu-item-description-<?php print $item_id; ?>">
											...
											<textarea id="edit-menu-item-description-<?php print $item_id; ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php print $item_id; ?>]"><?php print esc_html( $item->description ); ?></textarea>
