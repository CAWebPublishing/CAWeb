	...
	<div id="caweb-options-container">
		...
		<div id="general" class="<?php print 'general' === $selected_tab ? '' : 'hidden'; ?>">
			...
			<table class="form-table">
				<tr>
					<th scope="row">
						<div class="tooltip">Fav Icon
							<span class="tooltiptext">Select an icon to display as the page icon.</span></div>
					</th>
					<td>
						<input type="text" name="ca_fav_ico" id="ca_fav_ico_filename" size="75" readonly="true" style="background-color: #fff;" value="<?php print $fav_icon_name; ?>" class="library-link" name="ca_fav_ico" data-choose="Choose a Fav Icon" data-update="Set as Fav Icon" data-option="x-image/icon, image/x-icon, x-image/x-icon, image/icon" data-uploader="false" data-icon-check="true">
						<input type="hidden" name="ca_fav_ico" id="ca_fav_ico" size="75" value="<?php print $fav_icon; ?>">
				...
				<tr>
					<th scope="row">
						<div class="tooltip">State Template Version
							<span class="tooltiptext">Select one of the California state template versions.</span></div>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<div class="tooltip">Header Menu Type
							<span class="tooltiptext">Set a navigation menu style for all pages.</span></div>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<div class="tooltip">Menu Type Selector
							<span class="tooltiptext">Displays a header menu type selector on the page editor level.</span></div>
					</th>
					<td><input type="checkbox" name="ca_menu_selector_enabled" id="ca_menu_selector_enabled" <?php print $navigation_menu_selector ? 'checked="checked"' : ''; ?>>
					</td>
				</tr>
				<?php endif; ?>
				...
				<tr>
					<th scope="row">
						<div class="tooltip">Color Scheme
							<span class="tooltiptext">Apply a site wide color scheme.</span></div>
					</th>
					<td>
				...
				<tr class="extra <?php print $modern; ?>">
					<th scope="row">
						<div class="tooltip">Show Search on Front Page
							<span class="tooltiptext">Display a visible search box on the front page.</span></div>
					</th>
					<td><input type="checkbox" name="ca_frontpage_search_enabled" id="ca_frontpage_search_enabled" <?php print $frontpage_search_enabled; ?>>
					</td>
				</tr>
				<tr class="extra <?php print $modern; ?> ">
					<th scope="row">
						<div class="tooltip">Sticky Navigation
					...
					<td><input type="checkbox" name="ca_sticky_navigation" id="ca_sticky_navigation" <?php print $sticky_nav_enabled; ?>>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<div class="tooltip">Menu Home Link
							<span class="tooltiptext">Adds a Home link to the header menu.</span></div>
					</th>
					<td><input type="checkbox" name="ca_home_nav_link" id="ca_home_nav_link" <?php print $home_nav_link_enabled; ?>>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<div class="tooltip">Title Display Default Off
							<span class="tooltiptext">Checking this box defaults all new pages/posts to suppress the title.</span></div>
					</th>
					<td><input type="checkbox" name="ca_default_post_title_display" id="ca_default_post_title_display" <?php print $display_post_title; ?>>
					</td>
				</tr>
				<tr>
					<th scope="row">
						<div class="tooltip">Display Date for Non-Divi Posts
				...
				<tr>
					<th scope="row">
						<div class="tooltip">Legacy Browser Support
			...
			<div class="extra <?php print $modern; ?>">
				...
				<table class="form-table">
					...
					<tr>
						<th scope="row">
							<div class="tooltip">Contact Us Page
								<span class="tooltiptext">Select a page as the "Contact Us" page to be used in the utility header.</span></div>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<div class="tooltip">Enable Geo Locator
								<span class="tooltiptext">Displays a geo locator feature at the top right of each page.</span></div>
						</th>
						<td><input type="checkbox" name="ca_geo_locator_enabled" id="ca_geo_locator_enabled" <?php print $geo_locator_enabled; ?>> </td>
					</tr>
					<tr>
						<th scope="row">
							<div class="tooltip">Home Link
								<span class="tooltiptext">Adds a home link to the utility header.</span></div>
						</th>
						<td><input type="checkbox" name="ca_utility_home_icon" id="ca_utility_home_icon" <?php print $utility_header_home_icon; ?>>
						</td>
					</tr>
					<?php
					...
					<tr class="extra <?php print $modern; ?>">
						<th scope="row">
							<div class="tooltip">Custom Link <?php print $link; ?> Label
								<span class="tooltiptext">This is the text you want to display for this custom link in the utility header.</span>
							</div>
						</th>
						<td>
							<input type="text" name="ca_utility_link_<?php print $link; ?>_name" id="ca_utility_link_<?php print $link; ?>_name" size="50" value="<?php print $label; ?>" />
						</td>
					</tr>
					<tr class="extra <?php print $modern; ?>">
						<th scope="row">
							<div class="tooltip">Custom Link <?php print $link; ?> URL
								<span class="tooltiptext">Adds a custom link to the utility header.</span>
							</div>
						</th>
						<td>
							<input type="text" name="ca_utility_link_<?php print $link; ?>" id="ca_utility_link_<?php print $link; ?>" size="75" value="<?php print $url; ?>" />
						</td>
					</tr>
					<tr class="extra <?php print $modern; ?>">
						<th></th>
						<td>
							<label>Open in New Tab: <input type="checkbox" name="ca_utility_link_<?php print $link; ?>_new_window" id="ca_utility_link_<?php print $link; ?>_new_window" <?php print $target ? 'checked="checked"' : ''; ?> /></label>
						</td>
					</tr>
					<?php endfor; ?>
				</table>
			...
			<table class="form-table">
				...
				<tr>
					<th scope="row">
						<div class="tooltip">Organization Logo-Brand
							<span class="tooltiptext">Select an image to use as the agency logo. Recommended size is 300pixels wide by 80pixels tall</span></div>
					</th>
					<td>
						<input type="text" name="header_ca_branding" id="header_ca_branding_filename" size="75" value="<?php print $org_logo_filename; ?>">
						<input type="hidden" name="header_ca_branding" id="header_ca_branding" size="75" value="<?php print $org_logo; ?>">
				...
				<tr>
					<th scope="row">
						<div class="tooltip">Organization Logo-Alt Text
							<span class="tooltiptext">Enter alternative text for the agency logo image.</span></div>
					</th>
					<td>
				...
				<tr class="base <?php print $legacy; ?>">
					<th scope="row">
						<div class="tooltip ">Organization Logo Alignment
							<span class="tooltiptext">Select the position for the agency logo.</span></div>
					</th>
					<td>
				...
				<tr class="base <?php print $legacy; ?>">
					<th scope="row">
						<div class="tooltip">Header Background Image
							<span class="tooltiptext">Select the image to use as the background in the header of every page.</span></div>
					</th>
					<td>
						<input type="text" name="header_ca_background" id="header_ca_background_filename" size="75" value="<?php print $header_branding_background_filename; ?>">
						<input type="hidden" name="header_ca_background" id="header_ca_background" size="75" value="<?php print $header_branding_background; ?>">
			...
			<table class="form-table">
				...
				<tr>
					<th scope="row">
						<div class="tooltip">Search Engine ID
							<span class="tooltiptext">Enter your unique Google search engine ID, if you don't have one see an administrator.</span></div>
					</th>
					<td>
						<input type="text" name="ca_google_search_id" id="ca_google_search_id" size="60" value="<?php print $google_search_id; ?>">
					</td>
				</tr>
				<tr>
					<th scope="row">
						<div class="tooltip">Analytics ID
							<span class="tooltiptext">Enter your unique Google analytics ID, if you don't have one see an administrator.</span></div>
					</th>
					<td>
						<input type="text" name="ca_google_analytic_id" id="ca_google_analytic_id" size="60" value="<?php print $google_analytic_id; ?>">
					</td>
				</tr>
				<tr>
					<th scope="row">
						<div class="tooltip">Meta ID
							<span class="tooltiptext">Enter your unique Google meta ID, if you don't have one see an administrator.</span></div>
					</th>
					<td>
						<input type="text" name="ca_google_meta_id" id="ca_google_meta_id" size="60" value="<?php print $google_meta_id; ?>">
					</td>
				</tr>
				<tr>
					<th scope="row">
		...
		<div id="custom-css" class="<?php print 'custom-css' === $selected_tab ? '' : 'hidden'; ?>">
			...
			<table class="form-table">
				...
				<tr>
					<th>
						<div class="tooltip">Stylesheet<span class="tooltiptext">Any styles added will override any pre-existing styles. </span></div>
					</th>
					<td><textarea id="ca_custom_css" name="ca_custom_css"><?php print wp_unslash( $custom_css ); ?></textarea></td>
				</tr>
			</table>
		...
		<div id="custom-js" class="<?php print 'custom-js' === $selected_tab ? '' : 'hidden'; ?>">
			...
			<table class="form-table">
				...
				<tr>
					<th>
						<div class="tooltip">Javascript<span class="tooltiptext">Any scripts added will override any pre-existing scripts. </span></div>
					</th>
					<td><textarea id="ca_custom_js" name="ca_custom_js"><?php print wp_unslash( $custom_js ); ?></textarea></td>
				</tr>
			</table>
			...
			<ul id="cawebAlerts">
				...
				<li>
					<div class="caweb-alert">
						<div>
							<p><?php print $default_header; ?></p><a class="dashicons dashicons-dismiss removeAlert"></a><a class="thickbox dashicons dashicons-menu" href="#TB_inline?width=600&height=550&modal=true&inlineId=caweb-alert-<?php print $count; ?>"></a><a class="dashicons dashicons-arrow-down alert-toggle" title="<?php print $default_header; ?>"></a><a class="dashicons activateAlert <?php print $status; ?>"><input name="alert-status-<?php print $count; ?>" value="<?php print $status; ?>" type="hidden"></a>
						</div>
						<div class="hidden">
							<input placeholder="Label" name="alert-header-<?php print $count; ?>" type="text" value="<?php print $header; ?>">
							<p>Message</p>
...
<div id="caweb-alert-settings">
	...
	foreach ( $alerts as $a => $data ) {
		...
		printf(
			...
			$iconList,
			$data['icon'],
			isset( $data['text'] ) ? $data['text'] : 'More Information'
		);
	}
	?>
</div>
