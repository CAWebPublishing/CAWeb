...
<tr>
	...
	<tr <?= 'custom' !== get_option('ca_google_trans_enabled') ? ' class="hidden"' : '' ?>>
		...
		<td>
			<ul id="caweb-icon-menu" class="google">
			<?php
