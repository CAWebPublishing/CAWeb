...
<tr><th scope="row"><div class="tooltip">Fav Icon
    ...
    value="<?php print substr(get_option('ca_fav_ico', caweb_default_favicon_url()), strrpos(get_option('ca_fav_ico', caweb_default_favicon_url()), '/') ); ?>"  class="library-link" name="ca_fav_ico" data-choose="Choose a Fav Icon"
