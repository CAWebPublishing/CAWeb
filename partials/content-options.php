			...
			<table class="form-table">
				<tr><th scope="row"><div class="tooltip">Fav Icon
					...
					<td>
						...
						value="<?php print $fav_icon_name ?>"  class="library-link" name="ca_fav_ico" data-choose="Choose a Fav Icon"
								...
								<tr>
									<th scope="row"><div class="tooltip">Menu Type Selector
										...
										<td><input type="checkbox" name="ca_menu_selector_enabled" id="ca_menu_selector_enabled"
											<?php print $navigation_menu_selector ? 'checked="checked"' : '' ?>>
										</td>
									</tr>
								<?php endif; ?>
																													...
																													foreach ($alerts as $a => $data) :
																														...
																														<li>
																															<div class="caweb-alert">
																																<div><p><?php print $default_header ?></p><a class="dashicons dashicons-dismiss removeAlert"></a><a class="thickbox dashicons dashicons-menu" href="#TB_inline?width=600&height=550&modal=true&inlineId=caweb-alert-<?php print $count ?>"></a><a class="dashicons dashicons-arrow-down alert-toggle" title="<?php print $default_header ?>"></a><a class="dashicons activateAlert <?php print $status ?>"><input name="alert-status-<?php print $count ?>" value="<?php print $status ?>" type="hidden"></a></div>
																																<div class="hidden">
