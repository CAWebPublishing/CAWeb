        ...
        <div class="form-row">
            <div class="form-group col-sm-5">
                ...
                <select id="ca_site_version" name="ca_site_version" class="w-50 form-control">
                    <option class="legacy" value="5" <?php print 5 == $caweb_version ? 'selected="selected"' : '' ?>>Version 5.0</option>
                    <option value="5.5" <?php print 5.5 == $caweb_version ? 'selected="selected"' : '' ?>>Version 5.5</option>
                    <?php if (4 == $caweb_version) : ?>
                    <option class="legacy" value="4" <?php print 4 == $caweb_version ? 'selected="selected"' : '' ?>>Version 4.0</option>
                    <?php endif; ?>
                </select>
            </div>
        </div>
