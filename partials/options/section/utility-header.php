        ...
        <div class="form-row">
            ...
            <div class="form-group col">
                ...
                <div id="custom_link_<?php print $i ?>" class="collapse<?php print ! empty($enable) ? ' show' : ''  ?>">
                    ...
                    <small class="mb-2 text-muted d-block">This is the text you want to display for this custom link in the utility header.</small>
                    ...
                    <!-- Link Url -->
                     ...
                     <small class="mb-2 text-muted d-block">Adds a custom link to the utility header.</small>
