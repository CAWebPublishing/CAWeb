...
<div class="collapse border p-3" id="utility-header-settings" data-parent="#general-settings">
        ...
        <div class="form-row">
            <div class="form-group col-sm-5">
                <label for="ca_contact_us_link" class="d-block" data-toggle="tooltip" data-placement="top" title="Select a page as the &quot;Contact Us&quot; page to be used in the utility header."><strong>Contact Us Page</strong></label>
        ...
        <div class="form-row">
            ...
            <div class="form-group col-4">
                <label for="ca_geo_locator_enabled" class="d-block" data-toggle="tooltip" data-placement="top" title="Displays a geo locator feature at the top right of each page."><strong>Enable Geo Locator</strong></label>
            ...
            <!-- Home Link -->
            <div class="form-group col-4">
                <label for="ca_utility_home_icon" class="d-block" data-toggle="tooltip" data-placement="top" title="Adds a home link to the utility header."><strong>Home Link</strong></label>
        ...
        <div class="form-row">
            ...
            <div class="form-group col">
                ...
                <div id="custom_link_<?php print $i ?>" class="collapse<?php print ! empty($enable) ? ' show' : ''  ?>">
                    <!-- Link Label -->
                    <label for="<?php print $p ?>_name" class="d-block" data-toggle="tooltip" data-placement="top" title="This is the text you want to display for this custom link in the utility header."><strong>Custom Link <?php print $i ?> Label</strong></label>
                    <input type="text" name="<?php print $p ?>_name" id="<?php print $p ?>_name" class="form-control w-75" value="<?php print $name ?>"/>

                    <!-- Link Url -->
                     <label for="<?php print $p ?>" class="d-block" data-toggle="tooltip" data-placement="top" title="Adds a custom link to the utility header."><strong>Custom Link <?php print $i ?> URL</strong></label>
                    <input type="text" name="<?php print $p ?>" id="<?php print $p ?>" class="form-control w-75" value="<?php print $url ?>"/>

                     <!-- Link Target -->
                     <label for="<?php print $p ?>_new_window" class="d-block"><strong>Open in New Tab</strong></label>
