      ...
      global $wp_query;
			...
			if (have_posts()) :
				while (have_posts()) : the_post();
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('et_pb_post'); ?>>
						<a class="tag-link" href="<?php the_permalink(); ?>" >
           ...
           <?php et_divi_post_meta(); ?>
            ...
            <p> <?php truncate_post(270); ?></p>              
          	<a class="tag-link-read-more" href="<?php the_permalink(); ?>" >Read More<span class="sr-only">Read more about <?php the_title(); ?></span></a>
					</article> <!-- .et_pb_post -->
			<?php
					endwhile;
			?>
